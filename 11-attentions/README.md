...
- 第三步、计算value $b_1$：这些系数分别与 $\alpha_1$ Token的value( $v_1$)、 $\alpha_2$ Token的value( $v_2$)、 $\alpha_3$ Token的value( $v_3$)、 $\alpha_4$ Token的value( $v_4$)相乘，分别得到四个新的向量，再将这四个向量加起来就得到了 $b_1$ <br>
  $b_1$ = $\alpha_1'$ * $v_1$ + $\alpha_2'$ * $v_2$ + $\alpha_3'$ * $v_3$ + $\alpha_4'$ * $v_4$
